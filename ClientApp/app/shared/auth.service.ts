...
import { AuthHttp } from "./constants/auth.http";
...
export class AuthService {
    ...
    constructor(private http: AuthHttp, @Inject(ORIGIN_URL) private baseUrl: string) {

    }

    login(username: string, password: string): any {
      var url = `${this.baseUrl}/api/accounts/createtoken`;  // JwtProvider's LoginPath
     // alert(url);
